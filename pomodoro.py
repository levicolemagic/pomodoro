...
class PomodoroApp(object):
    ...
    def log_task(self):
        task_window = rumps.Window(message='What are you working on?')
        task_window.default_text = ""
    ...
    def get_user_input(self, _):
        pomodoro_window = rumps.Window(message='Set Pomodoro Duration (in minutes):')
        pomodoro_window.default_text = str(self.config["pomodoro_interval"] // 60)
        pomodoro_response = pomodoro_window.run()

        short_break_window = rumps.Window(message='Set Short Break Duration (in minutes):')
        short_break_window.default_text = str(self.config["short_break_interval"] // 60)
        short_break_response = short_break_window.run()

        long_break_window = rumps.Window(message='Set Long Break Duration (in minutes):')
        long_break_window.default_text = str(self.config["long_break_interval"] // 60)
